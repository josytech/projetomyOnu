...
export default function Asfalto() {
  return (
    <CaixaPrincipal>
            <Introducao>
                <EnglobaInf><Agaum>ASFALTO.</Agaum>
           
            </EnglobaInf>
            </Introducao>

            <Solucoes>
                <ParagrafosObj>Pavimentação das ruas</ParagrafosObj>
                <br/>
                <Paragrafos>
                ...
                <br/>
                <Paragrafos>
                    2- Criação de secretaria de fiscalização.
                </Paragrafos>
                <br/>
                <Paragrafos>
                3- Criação de um canal de comunicação,para a polulação informar buracos .
                </Paragrafos>
